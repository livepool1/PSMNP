<template>
  <ctable :formRuls="ruls" :aformWindow='addWindows' :aform="allCol" :headerData="headerData" server="/api/HEUPOMS/Location" :tableName="tableName"></ctable>
</template>
    ...
    return {
      ...
      allCol:{
            ...
            transUnit: {
                ...
                transUnitName: "",
                loc: null,
                transUnitPersonName: null,
                transUnitPersonContact: null
            }
      },
      headerData: [
